...
export default function managerselectedfood(state = INITIAL_STATE, action) {
  ...
  switch (action.type) {
    ...
    case SELECTEDADDCHANGESELECTEDFOOD:
      //选中菜单中的加
    ...
    case SELECTEDMINUSCHANGESELECTEDFOOD:
      //选中菜单中的减
      var index = action.index;
